...
const menuItemStyle = tva({
  base: "min-w-[200px] flex-row items-center rounded p-3 data-[active=true]:bg-background-100 data-[disabled=true]:data-[focus=true]:bg-transparent data-[focus=true]:bg-background-50 data-[hover=true]:bg-background-50 data-[disabled=true]:opacity-40 data-[disabled=true]:web:cursor-not-allowed data-[focus-visible=true]:web:cursor-pointer data-[focus=true]:web:outline-none data-[focus-visible=true]:web:outline data-[focus-visible=true]:web:outline-2 data-[focus=true]:web:outline-0 data-[focus-visible=true]:web:outline-primary-700",
});
