...
const accordionTriggerStyle = tva({
  base: "w-full flex-row items-center justify-between px-4 py-3 focus:outline-none data-[disabled=true]:cursor-not-allowed data-[focus-visible=true]:bg-background-50 data-[disabled=true]:opacity-40 web:outline-none",
});
